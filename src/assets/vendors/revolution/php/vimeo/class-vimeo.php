...
class TP_vimeo {
	...
	public function get_vimeo_videos($type,$value){
		...
		if($type=="user"){
			$url = "https://www.youtube.com/watch?v=Bvjl8cbbrrc&feature=youtu.be".$value."/videos.json";
		}
		else{
			$url = "https://www.youtube.com/watch?v=Bvjl8cbbrrc&feature=youtu.be".$type."/".$value."/videos.json";
		}
